      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text(
              "We have some delicious food options for you",
      ...
      children: [
        GestureDetector(
          ...
          child: Material(
              ...
              child: Container(
                decoration: BoxDecoration(
                    color: sweetFood ? Color(0Xffff5722) : Colors.white,
                    borderRadius: BorderRadius.circular(10)),
                ...
                child: Image.asset(
                  ...
                  width: 40,
                  fit: BoxFit.cover,
                  color: sweetFood ? Colors.white : Colors.black,
                ),
              )),
        ),
        GestureDetector(
          ...
          child: Material(
              ...
              child: Container(
                decoration: BoxDecoration(
                    color: fastFood ? Color(0Xffff5722) : Colors.white,
                    borderRadius: BorderRadius.circular(10)),
                padding: EdgeInsets.all(8),
                child: Image.asset(
                  "images/burger-icon.png",
                  height: 40,
                  width: 40,
                  fit: BoxFit.cover,
                  color: fastFood ? Colors.white : Colors.black,
                ),
              )),
        ),
        GestureDetector(
          ...
          child: Material(
              ...
              child: Container(
                decoration: BoxDecoration(
                    color: healthyFood ? Color(0Xffff5722) : Colors.white,
                    borderRadius: BorderRadius.circular(10)),
                padding: EdgeInsets.all(8),
                child: Image.asset(
                  "images/salad-icon.png",
                  height: 40,
                  width: 40,
                  fit: BoxFit.cover,
                  color: healthyFood ? Colors.white : Colors.black,
                ),
              )),
        )
      ],
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 5.0),
                                RatingBarIndicator(
                                  rating: ds["avgRating"] != null
                                      ? ds["avgRating"].toDouble()
                                      : 0.0,
